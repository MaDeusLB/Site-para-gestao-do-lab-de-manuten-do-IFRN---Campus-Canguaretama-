...
<head>
    ...
    $idcolab = filter_input(INPUT_GET, "idcolab");
    $nomecolab = filter_input(INPUT_GET, "nomecolab");
...
<body>
    ...
    <div class="container">
        ...
        <h1 class="text-center">Colaboradores Registradas </h1>
            ...
            <div class="col-lg-12">
                <table class="table">
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                <td scope="col"><?php echo $linha["nomecolab"] ?></td>
                                <td scope="col"><?php echo $linha["matricula"] ?></td>

                                <td scope="col">
                                    <?php echo "<a href='deletcolab.php?idcolab=" . $linha['idcolab'] . "'>Deletar</a>" ?>
